...
```r
uscrime <- read.csv('https://raw.githubusercontent.com/ChaiwonLee/chai_pjt/main/2023/uscrime/uscrime.csv?token=GHSAT0AAAAAACLY6AY3U3IPWMMGDODDI524ZMBSBEQ',fileEncoding = "utf-8")
```
<br/>
