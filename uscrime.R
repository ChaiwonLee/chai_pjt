...
# 1. 데이터 불러오기
uscrime <- read.csv('https://raw.githubusercontent.com/ChaiwonLee/chai_pjt/main/uscrime.csv?token=GHSAT0AAAAAACLY6AY3UQKK3IKA6U2W7I2QZMBP74Q',fileEncoding = "utf-8")
...
# 최대,최소 값을 찾아본 결과 North Dakota의 경우 살인사건(Murder), 폭행사건(Assault), 강간사건(Rape)모두 인구 100,000명 발생 건수가 가장 적은 것으로 나타남
